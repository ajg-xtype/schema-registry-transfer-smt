...
public class SchemaRegistryMock implements BeforeEachCallback, AfterEachCallback {
    ...
    public void beforeEach(final ExtensionContext context) {
        ...
        this.stubFor.apply(WireMock.get(WireMock.urlPathMatching(SCHEMA_BY_ID_PATTERN + "\\d+/(?:fetchMaxId=false&subject=)"))
    ...
    private int register(final String subject, final ParsedSchema schema) {
        try {
            ...
            this.stubFor.apply(WireMock.get(WireMock.urlEqualTo(SCHEMA_BY_ID_PATTERN + id + "?fetchMaxId=false&subject="))
